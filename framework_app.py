...
def main():
        ...
        fun.load_text(
                "https://presidentofindia.nic.in/speeches/address-honble-president-india-smt-droupadi-murmu-parliament-1",
        ...
        fun.load_text(
                "https://www.fiannafail.ie/news/speech-by-taoiseach-micheál-martin-on-the-announcement-of-members-of-government",
        ...
        fun.load_text("https://lims.leg.bc.ca/pdms/file/ldp/43rd1st/43rd1st-throne-speech.pdf", "canada_bc.txt",
                          label="Canada BC Throne Speech", parser = fp.extract_text_from_pdf)
        fun.load_text("https://www.gov.uk/government/speeches/the-kings-speech-2024", "uk_kings_speech.txt",
                          label="UK King's Speech", parser = fp.scrape_uk)
